  ...
  <div>
    ...
    <div v-if="items.histories && items.histories.length > 0">
      <v-card v-for="(q, index) in items.histories" :key="index" class="mt-2">
        <v-toolbar
          flat
          :color="q.correct_answer === q.my_answer ? 'green lighten-4' : 'red lighten-4'"
          dense
        >
        ...
        <v-card-text>
          <div class="row">
            <div class="col-md-5">
              ...
              <br>
                <div v-if=" q.correct_answer !== q.my_answer">Correct Answer:&nbsp;<span class="overline font-weight-bold">
                  {{ q.correct_answer }}</span></div>
            </div>
